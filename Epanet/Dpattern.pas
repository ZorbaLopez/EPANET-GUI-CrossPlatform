...
{$ENDIF}
  ...
  Grids, ExtCtrls, TAGraph, TASeries, System.UITypes, Uglobals,
  Uutils, ResourceStrings;
...
// Display line for average multiplier value
  ...
  begin
    ...
    AddXY(0, Avg, '', clDefault);
    AddXY(T, Avg, '', clDefault);
...
// Put grid in editing mode
  PostMessage(Grid1.Handle, {$IFDEF WINDOWS}WM_KeyDown
                            {$ELSE}LM_KEYDOWN{$ENDIF}, VK_F2, 0);
end;
