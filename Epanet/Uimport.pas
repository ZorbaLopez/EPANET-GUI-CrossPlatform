...
uses
 Classes, Forms, Controls, Dialogs, FileUtil, SysUtils, System.UITypes, Math,
 Uutils, Uglobals, ResourceStrings;
...
begin
  ...
  begin
    {Fsize := Uutils.GetFileSize(MapFile);  *Converted from GetFileSize* }
...
// Try to open the file
  ...
  // Create stringlists
    ...
    // Read the INP file
      ...
      Section := -1;
      {Result := ReadFile(F,Uutils.FileSize(Fname)  *Converted from GetFileSize* );}
...
begin
  ...
  begin
    ...
    try
      ...
      Section := -1;  //[END]
      {R := ReadFile(F,Uutils.FileSize(Fname) *Converted from GetFileSize* );}
