...
uses
  ...
  {$ENDIF}
  {$IFDEF DARWIN}
  LCLIntf, LCLType, LMessages, //iosxlocale,
  {$ENDIF}
  {$IFDEF LINUX}
  LCLIntf, LCLType, LMessages, //clocale,
  {$ENDIF}
  ...
  Themes, fpvectorialpkg, tachartfpvectorial,
  printer4lazarus, lhelpcontrolpkg,
  Dsource,
  ResourceStrings,
  OpenDlg,
  PgSetup,
