...
{$ENDIF}
  ...
  StdCtrls, Uglobals, Uutils, ExtCtrls, ResourceStrings;
...
// Make sure map will display junction symbols
  with MainForm.MapForm.Map.Options do
  begin
...
begin
  ...
  begin
    ...
    MainForm.MapForm.Map.Options.DispJuncs := OldDispJuncs;
    MainForm.MapForm.RedrawMap;
    MainForm.MapForm.DrawNodeLegend;
    MainForm.MapForm.DrawLinkLegend;
  end;
  MainForm.BrowserForm.NodeViewBox.Enabled := True;
  MainForm.BrowserForm.LinkViewBox.Enabled := True;
  Action := caHide;
end;
...
// Check for valid numerical entry for query comparison value
  ...
  // Disable selection of map view variable from Browser form
    MainForm.BrowserForm.NodeViewBox.Enabled := False;
    MainForm.BrowserForm.LinkViewBox.Enabled := False;
