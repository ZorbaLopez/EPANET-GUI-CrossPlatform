...
{$ENDIF}
  ...
  StdCtrls, ComCtrls, Uutils, Uglobals, ExtCtrls, NumEdit, ResourceStrings;
...
// Types of editing action that can be taken
  ActionItems : array[0..2] of string = (TXT_ACTION_ITEMS_REPLACE,
                                        TXT_ACTION_ITEMS_MULTIPLY,
                                        TXT_ACTION_ITEMS_ADD);
  ActionAdverb: array[0..2] of string = (TXT_ACTION_ADVERB_WITH,
                                        TXT_ACTION_ADVERB_BY,
                                        TXT_ACTION_ADVERB_TO);
...
// Update items in FilterProperty & EditProperty combo boxes
  ...
  EditAction.Items.AddStrings(ActionItems);
